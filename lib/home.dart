...
import 'dart:convert';
import 'package:komodowalls/models/categorie_model.dart';
import 'package:komodowalls/models/photos_model.dart';
import 'package:komodowalls/view/categorie_screen.dart';
import 'package:komodowalls/view/search_view.dart';
...
class _HomeState extends State<Home> {
  ...
  getCategories() async {
    var uri =
        Uri.parse("https://komodo-os.my.id/wallpaper/api/categories.json");
    await http.get(uri).then((value) {
      Map<String, dynamic> jsonData = jsonDecode(value.body);
      jsonData["result"].forEach((element) {
        //
        CategorieModel categorieModel = new CategorieModel();
        categorieModel.imgUrl = element["imgUrl"];
        categorieModel.categorieName = element["categorieName"];
